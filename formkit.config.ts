  ...
  config: {
    classes: generateClasses({
      global: {
        ...
        input: 'border-2 border-gray-300 p-2 rounded-md focus:outline-none focus:border-cyan-500 w-full focus:ring-cyan-500',
      },
      checkbox: {
        outer: 'space-y-10',
      ...
      submit: {
        input: '$reset bg-cyan-500 w-1/3 py-2 rounded-lg text-white font-semibold text-lg hover:bg-cyan-600 transition-colors mt-10'
      }
    })
  }
}
